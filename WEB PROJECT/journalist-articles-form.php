...
$sql = "SELECT * FROM Articles WHERE Article_ID =".$name;
...
<body>
    ...
    <form method="post" action="addArticle.php" enctype="multipart/form-data">
        <table class="writearticles">
            ...
            <tr>
                <td>Title</td>
                <td><input type="text" name="articleTitle" placeholder="write your title" value="<?php echo $title ?>"></td>
            </tr>
            <tr>
            <td>Image</td>
            ...
            <tr>
                <td>Article</td>
                <td><textarea rows="10" cols="40" name="content" ><?php echo $content ?></textarea></td>
            </tr>
            <tr>
